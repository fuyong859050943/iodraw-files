...
erDiagram
    ...
    product_message_config #lightgreen {
        BIGINT id PK "消息模板ID"
        BIGINT product_id FK "关联产品"
    ...
    equipment_message_system #lightgreen {
        BIGINT id PK "路由ID"
        BIGINT equipment_id FK "关联设备"
    ...
    equipment_analyze_config #orange {
        BIGINT id PK "解析配置ID"
        BIGINT product_id FK "关联产品"
